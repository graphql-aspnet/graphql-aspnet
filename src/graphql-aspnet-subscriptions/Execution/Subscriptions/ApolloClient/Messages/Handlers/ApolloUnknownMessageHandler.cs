...
namespace GraphQL.AspNet.Messaging.Handlers
{
    ...
    /// </summary>
    internal class ApolloUnknownMessageHandler : IApolloMessageHandler
    {
        /// <summary>
        ...
        public bool CanHandleMessage(IApolloMessage message)
        {
            return true;
        }
        ...
        public Task<IEnumerable<IApolloMessage>> HandleMessage(
