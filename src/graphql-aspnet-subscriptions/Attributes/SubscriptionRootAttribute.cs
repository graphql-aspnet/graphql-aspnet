...
namespace GraphQL.AspNet.Attributes
{
    ...
    public class SubscriptionRootAttribute : GraphFieldAttribute
    {
        ...
        public SubscriptionRootAttribute(string template, Type returnType)
            : base(true, SchemaItemPathCollections.Subscription, template, returnType)
        {
            this.EventName = null;
        }
        ...
        public SubscriptionRootAttribute(string template, Type returnType, params Type[] additionalTypes)
            : base(true, SchemaItemPathCollections.Subscription, template, (new Type[] { returnType }).Concat(additionalTypes ?? Enumerable.Empty<Type>()).ToArray())
        {
            this.EventName = null;
        }
