...
namespace GraphQL.AspNet
{
    ...
    public class SubscriptionPublisherExtension<TSchema> : ISchemaExtension
        where TSchema : class, ISchema
    {
        private SchemaOptions _primaryOptions;

        /// <summary>
        /// Initializes a new instance of the <see cref="SubscriptionPublisherExtension{TSchema}"/> class.
        /// </summary>
        public SubscriptionPublisherExtension()
        {
