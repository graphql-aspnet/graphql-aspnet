...
namespace GraphQL.AspNet.Common.Generics
{
    ...
    internal sealed class ConcurrentHashSet<T> : IReadOnlyCollection<T>, ICollection<T>
    {
        private const int DEFAULT_CAPACITY = 31;
        private const int MAX_LOCK_NUMBER = 1024;

        private static int DefaultConcurrencyLevel => ProcessorCounterInspector.Count;
        ...
        public void Clear()
        {
            ...
            try
            {
                ...
                var newTables = new Tables(new Node[DEFAULT_CAPACITY], _tables.Locks, new int[_tables.CountPerLock.Length]);
                _tables = newTables;
        ...
        public bool Add(T item) => this.AddInternal(item, _comparer.GetHashCode(item), true);
        ...
        private void InitializeFromCollection(IEnumerable<T> collection)
        {
            ...
            {
                this.AddInternal(item, _comparer.GetHashCode(item), false);
            }
        ...
        private void AcquireAllLocks(ref int locksAcquired)
        {
            ...
            this.AcquireLocks(1, _tables.Locks.Length, ref locksAcquired);
        }
        ...
        /// <summary>
        /// Releases the locks currently being held by this instance.
        /// </summary>
