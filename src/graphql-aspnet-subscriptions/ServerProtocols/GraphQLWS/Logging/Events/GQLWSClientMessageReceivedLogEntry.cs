...
namespace GraphQL.AspNet.ServerProtocols.GraphQLWS.Logging.Events
{
    ...
    /// </summary>
    public class GQLWSClientMessageReceivedLogEntry : GraphLogEntry
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            if (this.MessageId == null)
                return $"GraphQL-WS Message Received | Client Id: {idTruncated} (Type: '{this.MessageType}')";
            else
                return $"GraphQL-WS Message Received | Client Id: {idTruncated}, Message Id: {this.MessageId} (Type: '{this.MessageType}')";
        }
    }
}