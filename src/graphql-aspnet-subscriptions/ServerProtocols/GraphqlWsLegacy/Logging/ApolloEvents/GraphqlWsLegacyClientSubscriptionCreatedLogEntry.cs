...
namespace GraphQL.AspNet.GraphqlWsLegacy.Logging.GraphqlWsLegacyEvents
{
    ...
    /// <summary>
    /// Recorded whenever an GraphqlWsLegacy client proxy registers a new subscription
    /// and can send data to the connected client when events are raised.
    /// </summary>
    internal class GraphqlWsLegacyClientSubscriptionCreatedLogEntry : GraphLogEntry
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GraphqlWsLegacyClientSubscriptionCreatedLogEntry" /> class.
        /// </summary>
        /// <param name="client">The client.</param>
        /// <param name="subscription">The subscription that was created.</param>
        public GraphqlWsLegacyClientSubscriptionCreatedLogEntry(ISubscriptionClientProxy client, ISubscription subscription)
            : base(GraphqlWsLegacyLogEventIds.ClientSubscriptionStarted)
        {
