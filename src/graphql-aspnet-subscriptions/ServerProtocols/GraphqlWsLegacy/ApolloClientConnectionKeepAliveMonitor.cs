...
namespace GraphQL.AspNet.Apollo
{
    ...
    internal class ApolloClientConnectionKeepAliveMonitor<TSchema> : IDisposable
        where TSchema : class, ISchema
    {
        private readonly ApolloClientProxy<TSchema> _connection;
        ...
        public ApolloClientConnectionKeepAliveMonitor(ApolloClientProxy<TSchema> connection, TimeSpan interval)
        {
