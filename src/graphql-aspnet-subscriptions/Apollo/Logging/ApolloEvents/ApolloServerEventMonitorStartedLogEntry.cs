...
namespace GraphQL.AspNet.Apollo.Logging.ApolloEvents
{
    ...
    public class ApolloServerEventMonitorStartedLogEntry<TSchema> : GraphLogEntry
        where TSchema : class, ISchema
    {
        private readonly string _schemaTypeShortName;

        /// <summary>
        /// Initializes a new instance of the <see cref="ApolloServerEventMonitorStartedLogEntry{TSchema}" /> class.
        /// </summary>
        ...
        public ApolloServerEventMonitorStartedLogEntry(
        ...
        {
            return $"Server Event Monitor Started | Schema: {_schemaTypeShortName}, Event: {this.SubscriptionEventName}";
        }
    }
}