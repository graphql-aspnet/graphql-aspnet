    ...
    public class FragmentExecutionTests
    {
        ...
        public async Task MultiNestedNamedFragments_RendersCorrectly()
        {
            ...
            builder.AddQueryText(@"
                        ...
                        fragment frag1 on FragmentDataA{
                           ... frag2
                        }

                        fragment frag2 on FragmentDataA{
                           ... frag3
                        }
                        fragment frag3 on FragmentDataA{
                           ... frag4
                        }
                        fragment frag4 on FragmentDataA{
                           property1
                           ... frag5
                        }
                        fragment frag5 on FragmentDataA{
                           ... frag6
                        }
                        fragment frag6 on FragmentDataA{
                            property1
                           ... frag7
                        }
                        fragment frag7 on FragmentDataA{
                           ... frag8
                        }
                        fragment frag8 on FragmentDataA{
                            property2
                        }");
            ...
            var expectedReslt = @"
            {
                ""data"" : {
                        ""fragTester"": {
                            ...
                            {
                                ""property1"": ""fragmentA_prop1_0"",
                                ""property2"": ""fragmentA_prop2_0""
                            },
                            {
                                ""property1"": ""fragmentA_prop1_1"",
                                ""property2"": ""fragmentA_prop2_1""
                            }]
                        }
                }
            }";
