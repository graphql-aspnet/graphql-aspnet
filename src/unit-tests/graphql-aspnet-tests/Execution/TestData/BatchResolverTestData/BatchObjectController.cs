...
namespace GraphQL.AspNet.Tests.Execution.TestData.BatchResolverTestData
{
    ...
    [GraphRoute("batch")]
    public class BatchObjectController : GraphController
    {
        private readonly IBatchCounterService _counterService;

        public BatchObjectController(IBatchCounterService counterService)
        {
        ...
        [Query("fetchData", typeof(TwoPropertyObject), TypeExpression = "[Type]")]
