...
namespace GraphQL.AspNet.Tests.Execution
{
    ...
    public class IntrospectionTests
    {
        ...
        public void IntrospectedObject_PropertyCheck()
        {
            ...
            var expected0 = template.FieldTemplates.First(x => x.ItemPath.Path == $"[type]/{nameof(IntrospectableObject)}/{nameof(IntrospectableObject.Method1)}");
            var expected1 = template.FieldTemplates.First(x => x.ItemPath.Path == $"[type]/{nameof(IntrospectableObject)}/{nameof(IntrospectableObject.Method2)}");
            var expected2 = template.FieldTemplates.First(x => x.ItemPath.Path == $"[type]/{nameof(IntrospectableObject)}/{nameof(IntrospectableObject.Prop1)}");
