...
namespace GraphQL.AspNet.Tests.Schemas
{
    ...
    public class GraphFieldCollectionTests
    {
        ...
        public void Contains_ForUnReferencedField_IsNotFound()
        {
            ...
            var field1Other = Substitute.For<IGraphField>();
