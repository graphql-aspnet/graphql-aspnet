...
namespace GraphQL.AspNet.Tests.Schemas
{
    ...
    public class IntrospectionDefaultValueValidationTests
    {
            ...
            bool shouldSucceed)
        {
            ...
            inputField.Route.Returns(new SchemaItemPath(SchemaItemPathCollections.Types, "inputobject", "field1"));
            ...
            bool hasDefaultValue)
        {
            ...
            argument.Route.Returns(new SchemaItemPath(SchemaItemPathCollections.Types, "inputobject", "field1"));
