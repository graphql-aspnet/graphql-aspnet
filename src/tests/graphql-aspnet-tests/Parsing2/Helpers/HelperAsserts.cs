...
namespace GraphQL.AspNet.Tests.Parsing2.Helpers
{
    ...
    public class HelperAsserts
    {
        ...
        public static void AssertSynNodeChain(SourceText sourceText, SynTree tree, SynNodeTestCase topLevelNode)
        {
            AssertSynNodeChain(sourceText, tree, tree.RootNode, topLevelNode);
        }

        public static void AssertSynNodeChain(SourceText sourceText, SynTree tree, SynNode node, SynNodeTestCase testCase)
        {
        ...
        public static void AssertChildNodeChain(SourceText sourceText, SynTree tree, SynNode node, params SynNodeTestCase[] childTestCases)
        {
