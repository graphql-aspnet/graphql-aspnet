...
namespace GraphQL.AspNet.Tests.Parsing.NodeMakers
{
    ...
    public class FieldNodeMakerTests
    {
        ...
        public void FieldNodeMaker_InvalidFieldName_ThrowsException()
        {
            ...
            try
            {
                FieldNodeMaker.Instance.MakeNode(new SyntaxTree(), ref stream);
            }
        ...
        public void FieldNodeMaker_SingleFieldNoInputs_ParsesCorrectly()
        {
            ...
            var node = FieldNodeMaker.Instance.MakeNode(new SyntaxTree(), ref stream) as FieldNode;
        ...
        public void FieldNodeMaker_FieldWithAliasNoInputs_ParsesCorrectly()
        {
            ...
            var node = FieldNodeMaker.Instance.MakeNode(syntaxTree, ref stream) as FieldNode;
            Assert.IsNotNull(node);
