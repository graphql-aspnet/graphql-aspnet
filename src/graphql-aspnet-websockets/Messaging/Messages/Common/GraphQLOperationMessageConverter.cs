...
namespace GraphQL.AspNet.Messaging.Messages.Common
{
    ...
    /// </summary>
    public class GraphQLOperationMessageConverter : JsonConverter<IGraphQLOperationMessage>
    {
        /// <summary>
        ...
        public override void Write(Utf8JsonWriter writer, IGraphQLOperationMessage value, JsonSerializerOptions options)
        {
            ...
            writer.WriteString("type", GraphQLOperationMessageTypeExtensions.Serialize(value.Type));
