...
namespace GraphQL.AspNet.ValidationRules.RuleSets.DocumentConstruction.QueryFragmentSteps
{
    ...
    /// </summary>
    internal class QueryFragment_AssignGraphType : DocumentConstructionStep<IFragmentDocumentPart>
    {
        /// <summary>
        ...
        {
            var queryFragment = context.FindContextItem<IFragmentDocumentPart>();
