...
namespace GraphQL.AspNet.ValidationRules.RuleSets.DocumentValidation.QueryOperationSteps
{
    ...
    /// </summary>
    internal class Rule_5_2_2_1_LoneAnonymousOperation : DocumentPartValidationRuleStep<IOperationDocumentPart>
    {
        /// <summary>
        ...
        public override bool ShouldExecute(DocumentValidationContext context)
        {
            return base.ShouldExecute(context) &&
                   context.ActivePart is IOperationDocumentPart operation && operation.Name == string.Empty;
        }
