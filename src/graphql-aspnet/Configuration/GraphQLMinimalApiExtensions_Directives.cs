...
namespace GraphQL.AspNet.Configuration
{
    ...
    public static partial class GraphQLMinimalApiExtensions
    {
        ...
        public static IGraphQLDirectiveTemplate RequireAuthorization(
            this IGraphQLDirectiveTemplate directiveTemplate,
        ...
        /// <param name="directiveTemplate">The directive being built.</param>
        /// <returns>IGraphQLFieldBuilder.</returns>
        public static IGraphQLDirectiveTemplate AllowAnonymous(this IGraphQLDirectiveTemplate directiveTemplate)
        {
            Validation.ThrowIfNull(directiveTemplate, nameof(directiveTemplate));
        ...
        public static IGraphQLDirectiveTemplate IsRepeatable(this IGraphQLDirectiveTemplate directiveTemplate)
        {
        ...
        /// <returns>IGraphQLDirectiveTemplate.</returns>
        public static IGraphQLDirectiveTemplate RestrictLocations(
            this IGraphQLDirectiveTemplate directiveTemplate,
        ...
        /// <returns>IGraphQLFieldBuilder.</returns>
        public static IGraphQLDirectiveTemplate AddResolver(this IGraphQLDirectiveTemplate directiveTemplate, Delegate resolverMethod)
        {
        ...
        /// <returns>IGraphQLDirectiveTemplate.</returns>
        public static IGraphQLDirectiveTemplate MapDirective(this SchemaOptions schemaOptions, string directiveName)
        {
        ...
        /// <returns>IGraphQLDirectiveTemplate.</returns>
        public static IGraphQLDirectiveTemplate MapDirective(this SchemaOptions schemaOptions, string directiveName, Delegate resolverMethod)
        {
        ...
        /// <param name="directiveName">Name of the directive (e.g. '@myDirective').</param>
        /// <returns>IGraphQLDirectiveTemplate.</returns>
        public static IGraphQLDirectiveTemplate MapDirective(this ISchemaBuilder schemaBuilder, string directiveName)
        {
        ...
        /// <param name="resolverMethod">The resolver that will be executed when the directive is invoked.</param>
        /// <returns>IGraphQLDirectiveTemplate.</returns>
        public static IGraphQLDirectiveTemplate MapDirective(this ISchemaBuilder schemaBuilder, string directiveName, Delegate resolverMethod)
        {
            Validation.ThrowIfNull(schemaBuilder, nameof(schemaBuilder));
            Validation.ThrowIfNull(resolverMethod, nameof(resolverMethod));
