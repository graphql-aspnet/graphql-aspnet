...
namespace GraphQL.AspNet.Logging.GeneralEvents
{
    ...
    /// </summary>
    public class QueryExecutionPlanCacheAddLogEntry : GraphLogEntry
    {
        private readonly string _schemaTypeShortName;

        /// <summary>
        /// Initializes a new instance of the <see cref="QueryExecutionPlanCacheAddLogEntry" /> class.
        /// </summary>
        /// <param name="queryHash">The query hash.</param>
        /// <param name="queryPlan">The query plan.</param>
        public QueryExecutionPlanCacheAddLogEntry(string queryHash, IQueryExecutionPlan queryPlan)
