...
namespace GraphQL.AspNet.Schemas.Structural
{
    ...
    public class MethodGraphField : IGraphField
    {
        ...
        public MethodGraphField(
            ...
            IEnumerable<FieldSecurityAppliedPolicyGroup> securityPolicies = null)
        {
            this.Name = fieldName;
            ...
            this.SecurityGroups = securityPolicies ?? Enumerable.Empty<FieldSecurityAppliedPolicyGroup>();
        ...
        public IEnumerable<FieldSecurityAppliedPolicyGroup> SecurityGroups { get; }
