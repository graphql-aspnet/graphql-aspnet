...
namespace GraphQL.AspNet.Execution.RulesEngine
{
    ...
    internal sealed class DocumentConstructionRuleProcessor
    {
        ...
        /// <summary>
        /// Initializes static members of the <see cref="DocumentConstructionRuleProcessor"/> class.
        /// </summary>
        static DocumentConstructionRuleProcessor()
        {
            // capture the public processing depth value
            // so that is can't change once this processor is invoked for the first time
