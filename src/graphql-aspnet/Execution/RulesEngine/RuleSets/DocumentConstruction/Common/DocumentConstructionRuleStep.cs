...
namespace GraphQL.AspNet.Execution.RulesEngine.RuleSets.DocumentConstruction.Common
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DocumentConstructionRuleStep"/> class.
        /// </summary>
        ...
        protected DocumentConstructionRuleStep(SyntaxNodeType acceptableNodeType)
            : base(acceptableNodeType)
        {
        }
