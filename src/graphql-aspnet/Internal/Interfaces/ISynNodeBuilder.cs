...
namespace GraphQL.AspNet.Internal.Interfaces
{
    ...
    /// <summary>
    /// A builder object that will construct a single node of a <see cref="SynTree"/>
    /// from a stream of lexed token values.
    /// </summary>
    public interface ISynNodeBuilder
    {
        /// <summary>
        ...
        void BuildNode(ref SynTree synTree, ref SynNode parentNode, ref TokenStream tokenStream);
    }
}