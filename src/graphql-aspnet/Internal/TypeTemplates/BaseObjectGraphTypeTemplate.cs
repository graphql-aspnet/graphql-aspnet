...
namespace GraphQL.AspNet.Internal.TypeTemplates
{
    ...
    public abstract class BaseObjectGraphTypeTemplate : BaseGraphTypeTemplate
    {
        ...
        private FieldSecurityAppliedPolicyGroup _securityPolicies;
            ...
            : base(objectType)
        {
            ...
            _securityPolicies = FieldSecurityAppliedPolicyGroup.Empty;
        ...
        protected override void ParseTemplateDefinition()
        {
            ...
            // Security Policies
            // ------------------------------------
            _securityPolicies = FieldSecurityAppliedPolicyGroup.FromAttributeCollection(this.AttributeProvider);
        ...
        public override FieldSecurityAppliedPolicyGroup SecurityPolicies => _securityPolicies;
