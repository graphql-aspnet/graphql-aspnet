...
namespace GraphQL.AspNet.Interfaces.Configuration
{
    ...
    public interface ISchemaQueryExecutionPlanCacheConfiguration
    {
        ...
        /// </summary>
        /// <remarks>
        /// If this setting and <see cref="SlidingExpiration"/> are both null, then
        /// query plans will never expire.
        /// </remarks>
        ...
        /// </summary>
        /// <remarks>
        /// If this setting and <see cref="TimeToLiveInMilliseconds"/> are both null, then
        /// query plans will never expire.
        /// </remarks>
